      ...
      body: Stepper(
        ...
        steps: [
          Step(
            ...
            state:
                currentStepIndex >= 0 ? StepState.complete : StepState.disabled,
          ),
          Step(
            ...
            state:
                currentStepIndex >= 1 ? StepState.complete : StepState.disabled,
          ),
          Step(
            ...
            state:
                currentStepIndex >= 2 ? StepState.complete : StepState.disabled,
          ),
          Step(
